...
} from "firebase/auth"; // Import GoogleAuthProvider, signInWithCredential, and sendPasswordResetEmail
...
export default function Login() {
  ...
  const [request, response, promptAsync] = Google.useAuthRequest({
    ...
    webClientId:
      "846245652608-0tmh35shs7l8s19rvcuk8betfc8q0r05.apps.googleusercontent.com",
    scopes: ["profile", "email"],
    redirectUri: AuthSession.makeRedirectUri({}), // Use Expo's proxy
  });
